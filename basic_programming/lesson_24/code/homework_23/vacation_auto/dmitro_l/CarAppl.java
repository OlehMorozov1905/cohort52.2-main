package homework_23.vacation_auto.dmitro_l;
...
import homework_23.vacation_auto.dmitro_l.model.Car;
...
public class CarAppl {
    ...
    private static int indexOfBestChoice(double[] totalCosts) {
        ...
        int index = 0; // записываем индекс минимального значения, чтобы по нему потом найти машину в массиве машин
