package homework_23.vacation_auto.dmitro_l.model;
...
public class Car {
    ...
    public boolean equals(Object o) {
        ...
        return fuelType == car.fuelType && Double.compare(fuelCost, car.fuelCost) == 0 && Double.compare(fuelConsumption, car.fuelConsumption) == 0 && rentalCost == car.rentalCost && Objects.equals(brand, car.brand);
    }
    ...
    public double calculateTotalOperatingCost(int distance, int numberOfTravelDays) {
        double fuelCostForTrip = (distance / 100.0) * this.fuelConsumption * this.fuelCost; // стоимость топлива на поездку
        double tripRentalCost = (this.rentalCost / 7.0) * numberOfTravelDays; // стоимость аренды за поездку с учетом
        // цены в неделях
