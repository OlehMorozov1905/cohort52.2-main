...
public class Planet implements Comparable<Planet>{
   ...
   private int numOfSatellite;
    ...
    public boolean equals(Object o) {
        ...
        return Double.compare(distance, planet.distance) == 0 && Double.compare(mass, planet.mass) == 0 && numOfSatellite == planet.numOfSatellite && Objects.equals(name, planet.name);
    }

    @Override
    public int hashCode() {
        return Objects.hash(name, distance, mass, numOfSatellite);
    }
